...
.text
    ...
    la      a0, .INPUT_STRING
    la      a4, FLOOR   
    li      s0, 0       # s0: Floors processed in input string
    li      s1, 0       # s1: Position of first basement

loop:
    addi    s0, s0, 1       # Increment current change

    lb      t1, (a0)
    beqz    t1, end_loop    # End of input reached
